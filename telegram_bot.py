...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_text = (
        f"🤝 *Welcome, Partner.*\n\n"
        f"I am your **Elite Business CEO & Strategic Assistant**. "
        f"Together, we will manage and scale the Jeenora ecosystem.\n\n"
        f"💼 *My Executive Suite:*\n"
        f"• 🧠 **Autonomous Strategic Oversight**: I supervise all specialized agents.\n"
        f"• 🔍 **Deep Market Analytics**: SEO, PageSpeed, and Competitor Audits.\n"
        f"• 📊 **Operations Control**: Real-time sales, inventory, and CRM tracking.\n"
        f"• 💻 **Infrastructure Vigilance**: 24/7 monitoring of your workstation.\n\n"
        f"How shall we proceed today? You can command me via:\n"
        f"➡️ /strategy - Launch a full business audit\n"
        f"➡️ /status - Check our systems health\n"
        f"➡️ /logs - Audit the latest agent logs"
    )
